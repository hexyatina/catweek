...
**Dynamic** — IDs increment on each data reset. Refresh every session:
- `/lookup/lecturers`
- `/lookup/venues`
- `/lookup/lessons`
- `/lookup/groups`
...
- `GET /schedule?detailed` — returns full entry with all fields
    ...
    "tags": [
        ...
        {
            "name": "Lookup",
            "description": "Reference data for filter dropdowns. Stable IDs: days, slots, specialties. Dynamic IDs: lecturers, venues, lessons, groups."
        }
    ],
    "securityDefinitions": {
        "ApiKeyAuth": {
            ...
            "allOf": [
                {"$ref": "#/definitions/ScheduleEntry"},
                {
                    ...
                    "properties": {
                        ...
                        "is_short":             {"type": "boolean", "example": False, "description": "True for shortened day slots (6-10), False for normal slots (1-5)"},
