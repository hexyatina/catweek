...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["specialty_id"], ["schedule.specialties.specialty_id"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["day_id"], ["schedule.days.day_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["group_id"], ["schedule.student_groups.group_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["lecturer_id"], ["schedule.lecturers.lecturer_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["lesson_id"], ["schedule.lessons.lesson_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["slot_id"], ["schedule.slots.slot_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["venue_id"], ["schedule.venues.venue_id"], ondelete="SET NULL"
        ),
