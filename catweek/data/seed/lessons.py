LESSONS = [
    ...
    {"lesson_name": "Об'єктно-орієнтоване програмування", "lesson_code": "ООП"},
    {"lesson_name": "Інтелектуальний аналіз даних", "lesson_code": "ІАД"},
    {"lesson_name": "Чисельні методи", "lesson_code": "Чисмети"},
    {"lesson_name": "Інструментальні засоби візуального програмування", "lesson_code": "ІЗВП"},
    {"lesson_name": "Диференціальні рівняння", "lesson_code": "Дифури"},
]